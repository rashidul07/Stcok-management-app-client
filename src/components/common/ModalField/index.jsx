                ...
                isMarket ?
                    <div className='flex items-center mt-2'>
                        <input
                            ...
                            onChange={(e) => {
                                const updatedProduct = { ...product, info: e.target.value };
                                handleSetEditableRowData(updatedProduct);
                            }}
                            className={`bg-white text-sm px-2 rounded-md border-gray-600 border-0 text-center mx-1 w-3/6 h-8`}
                        />
                        <input
                            type="text"
                            value={product.mrp || ""}
                            ...
                            className={`bg-white text-sm px-2 rounded-md border-gray-600 border-0 text-center mx-1 w-20 h-8`}
                        />
                        <input
                            type="text"
                            value={product.lpp || ''}
                            ...
                            className={`bg-white text-sm px-2 rounded-md border-gray-600 border-0 text-center mx-1 my-1 w-20 h-8`}
                        />
                    </div> : ''
            }
        </>
